...
from batteries.venus_battery_shelly import VenusBatteryShelly
from core.mqtt_publisher import MqttPublisher
import os
from dotenv import load_dotenv
from utils.logger import get_logger
from core.config_loader import load_config
from core.shelly_controller import ShellyController
...
if __name__ == "__main__":
    ...
    controller.start_udp_proxy()
    # Real HomeWizard P1 meter
    meter_ip = config["P1_HOST"]
    battery_1_ip = config["BATTERY_1_IP"]
    battery_1_modbus_ip = config.get("BATTERY_1_MODBUS_IP", None)
    ...
    batteries = [
        VenusBatteryShelly(ShellyController=controller,battery_ip=battery_1_ip ,modbus_ip=battery_1_modbus_ip, unit_id=battery_1_address, name="VenusBattery1",port=battery_1_port)
    ]
